                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS total_users FROM user WHERE role != 'admin'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['total_users'];
                                    ?>
                                </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS agents FROM user WHERE role = 'agent'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['agents'];
                                    ?>
                                </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS sellers FROM user WHERE role = 'seller'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['sellers'];
                                    ?>
                                </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS apartments FROM property_listings WHERE property_type = 'apartment'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['apartments'];
                                    ?>
                                </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS houses FROM property_listings WHERE property_type = 'house'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['houses'];
                                    ?>
                                </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS sale FROM property_listings WHERE property_type = 'for_sale'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['sale'];
                                    ?>
                                </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    <?php
                                    $sql = "SELECT COUNT(*) AS rental FROM property_listings WHERE property_type = 'rental'";
                                    $query = $con->query($sql);
                                    echo $query->fetch_assoc()['rental'];
                                    ?>
                                </h3>
